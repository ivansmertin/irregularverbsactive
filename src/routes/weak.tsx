  ...
  return (
    <div className="space-y-5">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight md:text-3xl">Слабые глаголы</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Глаголы, где точность ниже 70% или вы отметили их сложными.
          </p>
        </div>
        {ids.length > 0 && (
      ...
      {ids.length === 0 ? (
        <Card>
          <CardContent className="pt-6 text-center text-sm text-muted-foreground">
            Слабых глаголов пока нет. Продолжайте практиковаться — они появятся автоматически.
          </CardContent>
        </Card>
      ) : (
