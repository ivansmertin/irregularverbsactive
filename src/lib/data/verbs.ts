...
const EXTRA_VERBS: Verb[] = [
  ...
  n(
    ...
    "The pipe burst.",
    "The balloon has burst.",
    { exPassive: "The door was burst open." },
  ),
  n(
    "cast",
    "cast",
    "cast",
    "бросать, назначать (роль)",
    "aaa",
    "He cast a stone into the river.",
    "She has been cast in the film.",
    "cast — cast — cast",
    "He cast a stone.",
    "She has been cast in the film.",
    { exPassive: "She was cast as the lead." },
  ),
  n(
    "hurt",
    "hurt",
    ...
    "My leg hurt.",
    "I have hurt my hand.",
    { frequency: "high", exPassive: "He was hurt in the accident." },
  ),
  n(
    "quit",
    "quit",
    "quit",
    "бросать (занятие), увольняться",
    "aaa",
  ...
  n(
    ...
    "I read the book.",
    "I have read it twice.",
    { frequency: "high", hint: "Произношение меняется: read [riːd] — read [red] — read [red]." },
  ),
  n(
    "set",
    "set",
    ...
    "She set the table.",
    "He has set a new record.",
    { frequency: "high", exPassive: "The date was set." },
  ),
  n(
    "split",
    "split",
    ...
    "They split the bill.",
    "The group has split.",
    { exPassive: "The wood was split in two." },
  ),
  n(
    "spread",
    "spread",
    "spread",
    "распространять, намазывать",
    "aaa",
    "The fire spread quickly.",
    "The news has spread fast.",
    "spread — spread — spread",
    "The fire spread fast.",
    "The news has spread.",
    { exPassive: "Butter was spread on the bread." },
  ),
  n(
    "bet",
    "bet",
  ...
  n(
    ...
    "They have broadcast the news.",
    "broadcast — broadcast — broadcast",
    "They broadcast the match live.",
    "It has been broadcast already.",
    { exPassive: "The match was broadcast live." },
  ),
  n(
    "forecast",
    "forecast",
    ...
    "прогнозировать",
    "aaa",
    "They forecast rain for Monday.",
    "Experts have forecast a recession.",
    "forecast — forecast — forecast",
    "They forecast rain.",
    "Experts have forecast a slowdown.",
    { exPassive: "Rain was forecast for today." },
  ),
  n(
    "bid",
    "bid",
    ...
    "предлагать цену",
    "aaa",
    "She bid a hundred dollars.",
    "He has bid for the painting.",
    "bid — bid — bid",
    "She bid a hundred dollars.",
    "He has bid for the painting.",
  ),
  n(
    ...
    "shed",
    "shed",
    "проливать (слёзы), сбрасывать",
    "aaa",
    "The tree shed its leaves.",
    "She has shed a few tears.",
    "shed — shed — shed",
    "The tree shed its leaves.",
    "She has shed a few tears.",
  ),
  n(
    ...
    "She has thrust the door open.",
    "thrust — thrust — thrust",
    "He thrust the letter at me.",
    "She has thrust the door open.",
  ),
  n(
    "upset",
    ...
    "The news upset her.",
    "You have upset me.",
    { exPassive: "She was upset by the news." },
  ),
  ...
  n(
    ...
    "abb",
    "He dug a deep hole.",
    "They have dug a tunnel.",
    "dig — dug — dug",
    "He dug a hole.",
    "They have dug a tunnel.",
    { exPassive: "A hole was dug in the garden." },
  ),
  n(
    "dream",
    "dreamed",
    ...
    "She has dreamt of this moment.",
    {
      alternativePastSimple: ["dreamt"],
      alternativePastParticiple: ["dreamt"],
      hint: "Обе формы dreamed и dreamt верны. Dreamt чаще в британском английском.",
    },
  ),
  n(
    "hang",
    ...
    "I have hung my coat.",
    {
      exPassive: "The picture was hung on the wall.",
      hint: "В значении 'казнить через повешение' используется правильная форма hanged.",
    },
  ),
  n(
    "hear",
    ...
    { frequency: "high", exPassive: "His voice was heard from afar." },
  ),
  n(
    "hold",
    "held",
    ...
    "abb",
    "She held my hand.",
    "They have held three meetings.",
    "hold — held — held",
    "She held my hand.",
    "They have held a meeting.",
    { frequency: "high", exPassive: "The conference was held in May." },
  ),
  n(
    "lay",
    "laid",
    ...
    "He has laid the table.",
    "lay — laid — laid",
    "She laid the baby down.",
    "He has laid the table.",
    { hint: "Не путать с lie — lay — lain ('лежать')." },
  ),
  n(
    "leap",
    "leaped",
    ...
    "He has leapt over the fence.",
    "leap — leaped, leapt — leaped, leapt",
    "The cat leaped onto the chair.",
    "He has leapt over the fence.",
    { alternativePastSimple: ["leapt"], alternativePastParticiple: ["leapt"] },
  ),
  n(
    "learn",
    "learned",
    ...
    {
      frequency: "high",
      alternativePastSimple: ["learnt"],
      alternativePastParticiple: ["learnt"],
      hint: "Обе формы допустимы. Learnt чаще в британском, learned в американском.",
    },
  ),
  n(
    "light",
    ...
    "He lit a candle.",
    "She has lit the fire.",
    { exPassive: "The room was lit by candles." },
  ),
  n(
    "mean",
    "meant",
  ...
  n(
    ...
    "abb",
    "I paid the bill.",
    "She has paid for everything.",
    "pay — paid — paid",
    "I paid the bill.",
    "She has paid for everything.",
    { frequency: "high", exPassive: "The bill was paid in cash." },
  ),
  n(
    "sell",
    "sold",
    ...
    "He sold his car.",
    "They have sold the house.",
    { frequency: "high", exPassive: "The tickets were sold out." },
  ),
  n(
    "shine",
    "shone",
  ...
  n(
    ...
    "abb",
    "He shot an arrow.",
    "She has shot a film here.",
    "shoot — shot — shot",
    "He shot an arrow.",
    "She has shot a great film.",
    { exPassive: "He was shot in the leg." },
  ),
  n(
    "slide",
    "slid",
  ...
  n(
    ...
    "She has smelt the flowers.",
    "smell — smelled, smelt — smelled, smelt",
    "I smelled smoke.",
    "She has smelt the flowers.",
    { alternativePastSimple: ["smelt"], alternativePastParticiple: ["smelt"] },
  ),
  n(
    "spell",
    "spelled",
    ...
    "писать по буквам",
    "abb",
    "He spelled his name slowly.",
    "She has spelt it correctly.",
    "spell — spelled, spelt — spelled, spelt",
    "He spelled his name.",
    "She has spelt it correctly.",
    { alternativePastSimple: ["spelt"], alternativePastParticiple: ["spelt"] },
  ),
  n(
    "spill",
    "spilled",
    ...
    "abb",
    "I spilled my coffee.",
    "He has spilt the milk.",
    "spill — spilled, spilt — spilled, spilt",
    "I spilled my coffee.",
    "He has spilt the milk.",
    { alternativePastSimple: ["spilt"], alternativePastParticiple: ["spilt"] },
  ),
  n(
    "stick",
    "stuck",
  ...
  n(
    ...
    "The workers have struck for higher pay.",
    "strike — struck — struck",
    "Lightning struck the tree.",
    "Workers have struck for pay.",
    { exPassive: "He was struck by lightning." },
  ),
  n(
    "swing",
    "swung",
  ...
  n(
    ...
    "I have burnt the toast.",
    { frequency: "high", alternativePastSimple: ["burnt"], alternativePastParticiple: ["burnt"] },
  ),
  n(
    "spit",
    "spat",
    ...
    "The cat has spat at me.",
    "spit — spat — spat",
    "He spat on the ground.",
    "The cat has spat at me.",
    { alternativePastSimple: ["spit"], alternativePastParticiple: ["spit"] },
  ),
  n(
    "wind",
    "wound",
  ...
  n(
    ...
    "связывать",
    "abb",
    "They bound the books in leather.",
    "We have bound the contract.",
    "bind — bound — bound",
    "They bound the books.",
    "We have bound the contract.",
    { exPassive: "She was bound by the agreement." },
  ),
  n(
    "grind",
    "ground",
    ...
    "He has ground the knife sharp.",
    "grind — ground — ground",
    "She ground the coffee.",
    "He has ground the knife.",
  ),
  n(
    "foretell",
    "foretold",
  ...
  n(
    ...
    "We have upheld our promise.",
    "uphold — upheld — upheld",
    "The court upheld the decision.",
    "We have upheld our promise.",
    { exPassive: "The verdict was upheld." },
  ),
  n(
    "misunderstand",
    "misunderstood",
  ...
  n(
    ...
    "We have rebuilt the house.",
    "rebuild — rebuilt — rebuilt",
    "They rebuilt the bridge.",
    "We have rebuilt the house.",
    { exPassive: "The city was rebuilt after the war." },
  ),
  n(
    "repay",
    "repaid",
  ...
  n(
    ...
    "The dog bit me.",
    "I have been bitten.",
    { exPassive: "He was bitten by a dog." },
  ),
  n(
    "forbid",
    "forbade",
    ...
    "запрещать",
    "abc",
    "Her parents forbade the trip.",
    "Smoking has been forbidden here.",
    "forbid — forbade — forbidden",
    "They forbade the trip.",
    "Smoking has been forbidden.",
    { exPassive: "Smoking is forbidden here." },
  ),
  n(
    "forgive",
    "forgave",
  ...
  n(
    ...
    "замораживать",
    "abc",
    "The lake froze in January.",
    "The food has frozen solid.",
    "freeze — froze — frozen",
    "The lake froze.",
    "The food has frozen.",
    { exPassive: "The pipes were frozen." },
  ),
  n(
    "hide",
    "hid",
    ...
    "He hid the keys.",
    "She has hidden the letter.",
    { exPassive: "The treasure was hidden in the cave." },
  ),
  n(
    "steal",
    "stole",
    ...
    "Someone stole my bike.",
    "My wallet has been stolen.",
    { exPassive: "The car was stolen last night." },
  ),
  n(
    "tear",
    "tore",
    ...
    "I have torn my jeans.",
    "tear — tore — torn",
    "She tore the letter.",
    "I have torn my jeans.",
    { exPassive: "The paper was torn." },
  ),
  n(
    "wear",
    "wore",
  ...
  n(
    ...
    "ткать, плести",
    "abc",
    "She wove a beautiful rug.",
    "They have woven a tapestry.",
    "weave — wove — woven",
    "She wove a rug.",
    "They have woven a tapestry.",
    { exPassive: "The basket was woven by hand." },
  ),
  n(
    "bear",
    "bore",
    ...
    "He has borne the responsibility.",
    "bear — bore — borne",
    "She bore the pain.",
    "He has borne the burden.",
    { hint: "Третья форма born используется только в значении 'рождённый': He was born in 1990." },
  ),
  n(
    "forget",
    "forgot",
  ...
  n(
    ...
    "предвидеть",
    "abc",
    "Nobody foresaw the crisis.",
    "We have foreseen this outcome.",
  ...
  n(
    ...
    "underwent",
    "undergone",
    "проходить через, переносить",
    "abc",
    "She underwent surgery last week.",
    "The plan has undergone changes.",
  ...
  n(
    ...
    "She has rewritten the chapter.",
    "rewrite — rewrote — rewritten",
    "He rewrote the essay.",
    "She has rewritten the chapter.",
    { exPassive: "The book was rewritten." },
  ),
  ...
  n(
    ...
    "We have overcome many problems.",
  ...
  n(
    ...
    "The ship sank.",
    "The boat has sunk.",
    { exPassive: "The ship was sunk by a storm." },
  ),
  ...
  n(
    ...
    "кровоточить",
    "ee-e-e",
    "His nose bled all morning.",
    "The cut has bled a lot.",
    "bleed — bled — bled",
    "His nose bled.",
    "The cut has bled a lot.",
  ),
  n(
    ...
    "ee-e-e",
    "They bred horses for years.",
    "She has bred prize-winning dogs.",
    "breed — bred — bred",
    "They bred horses.",
    "She has bred dogs.",
  ),
  ...
  n(
    ...
    "He has led this project.",
    "lead — led — led",
    "She led the team.",
    "He has led the project.",
    { frequency: "high", exPassive: "The team was led by Anna." },
  ),
  n(
    "speed",
    "sped",
    ...
    "The car sped away.",
    "Time has sped by.",
    { alternativePastSimple: ["speeded"], alternativePastParticiple: ["speeded"] },
  ),
  n(
    "sweep",
    "swept",
    ...
    "ee-e-e",
    "She swept the floor.",
    "He has swept the leaves up.",
    "sweep — swept — swept",
    "She swept the floor.",
    "He has swept the leaves.",
  ),
  n(
    "weep",
    "wept",
  ...
  n(
    ...
    "They misled the public.",
    "He has misled us.",
    { exPassive: "We were misled by the report." },
  ),
  ...
  n(
    ...
    "искать, добиваться",
    "ought-aught",
    "She sought advice from a friend.",
    "We have sought help everywhere.",
    "seek — sought — sought",
    "She sought advice.",
    "We have sought help.",
  ),
  ...
  n(
    ...
    "He drew a picture.",
    "She has drawn a map.",
    { frequency: "high", exPassive: "Lots were drawn at random." },
  ),
  n(
    "withdraw",
    "withdrew",
    "withdrawn",
    "снимать (деньги), отзывать",
    "ow-ew-own",
    "He withdrew some cash.",
    "She has withdrawn from the race.",
    "withdraw — withdrew — withdrawn",
    "He withdrew some cash.",
    "She has withdrawn from the race.",
    { exPassive: "The offer was withdrawn." },
  ),
  ...
  n(
    ...
    "She has forsaken her hometown.",
    "forsake — forsook — forsaken",
    "He forsook his friends.",
    "She has forsaken her town.",
  ),
  n(
    "undertake",
    "undertook",
    ...
    "ake-ook-aken",
    "She undertook the project alone.",
  ...
  n(
    ...
    "She has proven her skill.",
    {
      alternativePastParticiple: ["proven"],
      hint: "Допустимы обе третьи формы: proved (BrE) и proven (AmE).",
    },
  ),
  n(
    "show",
    ...
    {
      frequency: "high",
      alternativePastParticiple: ["showed"],
      exPassive: "The film was shown last night.",
    },
  ),
  n(
    "sew",
    ...
    "He has sewn the button on.",
    "sew — sewed — sewn",
    "She sewed a new dress.",
    "He has sewn the button on.",
    { alternativePastParticiple: ["sewed"] },
  ),
  n(
    "sow",
    "sowed",
    ...
    "сеять",
    "mixed",
    "We sowed the seeds in April.",
    "Farmers have sown the fields.",
    "sow — sowed — sown",
    "We sowed the seeds.",
    "Farmers have sown the fields.",
    { alternativePastParticiple: ["sowed"] },
  ),
  n(
    "beat",
    "beat",
    ...
    "Our team beat them.",
    "She has beaten the record.",
    { frequency: "high", exPassive: "They were beaten in the final." },
  ),
];
...
export function validateVerbs(verbs: Verb[] = VERBS): VerbValidationIssue[] {
  ...
  for (const verb of verbs) {
    ...
    if (!verb.infinitive)
      issues.push({ verbId: id, field: "infinitive", message: "Missing infinitive" });
    if (!verb.pastSimple)
      issues.push({ verbId: id, field: "pastSimple", message: "Missing pastSimple" });
    if (!verb.pastParticiple)
      issues.push({ verbId: id, field: "pastParticiple", message: "Missing pastParticiple" });
    if (!verb.translation)
      issues.push({ verbId: id, field: "translation", message: "Missing translation" });
    ...
    if (seenInfinitives.has(verb.infinitive)) {
      issues.push({
        verbId: id,
        field: "infinitive",
        message: `Duplicate infinitive: ${verb.infinitive}`,
      });
    }
    ...
    if (!verb.examples?.pastSimple || !verb.examples?.presentPerfect) {
      issues.push({
        verbId: id,
        field: "examples",
        message: "Missing pastSimple/presentPerfect example",
      });
    }
    ...
    if (sentences.length < 2) {
      issues.push({
        verbId: id,
        field: "shadowing.sentenceTexts",
        message: "Need at least 2 sentences",
      });
    }
...
export const VERBS_BY_ID: Record<string, Verb> = Object.fromEntries(VERBS.map((vb) => [vb.id, vb]));
